...
const Form = () => {
  ...
  const enviarForm = ( data) => {
    console.log(data);
    document.querySelector(".mensaje").innerHTML = `<h3>Hola  ${data.nombre}, te contactaremos </h3>`;
  }

  const esquemaContacto = Yup.object({
    nombre: Yup.string().min(5, "El nombre debe tener más de 5 letras").required("Ingresa un nombre valido"),
    email: Yup.string().email("Debe ingresar un email válido").required("Ingresa un email válido")
  })
